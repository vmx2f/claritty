                    ...
                    <form onSubmit={handleCreateOrg} className="relative z-10 space-y-8">
                        ...
                        <div className="flex items-center justify-center gap-3 mb-8">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-medium text-primary-text">Create Organization</span>
                            </div>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-secondary-text">Start Using Dashboard</span>
                            </div>
                        </div>

                        {/* Input section */}
                        <div className="space-y-2">
                            <label htmlFor="orgName" className="block text-sm font-semibold text-primary-text mb-3">
                                Organization Name
                            </label>
